...
Generated by `uv run python bench/demo.py --subject S-0042` on 2026-09-10; every block below is captured from that run. Subject ids are shown as HMACs; the raw id never reaches disk.
...
```text
$ tombstone erase --trace 7JKJW3BMBW90H719YERDT80M6G --reason dsr-2026-0912 --confirm --semantic
...
phase 2 reclaim
  ...
  lora/support-v3   exact retrain: shard 2 of 16       model VERIFIED             canary 0/4
...
receipt: /Users/poojanpatel/Documents/Projects/tombstone/bench/_work/demo2/.tombstone/receipts/01M25QXYQMN96Q0C18PMEFMTG6.json   ed25519 signed   chain ok
  VERIFIED  19   UNVERIFIED 0   RESIDUAL 4   OUT_OF_SCOPE 3 (backups, WAL, provider-side embeddings)
  id 01M25QXYQMN96Q0C18PMEFMTG6   semantics v1
...
```text
$ tombstone erase --trace 181T6RK68CQ82Q9QQX2ZC2804A --reason dsr-2026-0913 --confirm
phase 1 suppress    23/23 artifacts tombstoned         (retrieval filter active)
phase 2 reclaim
...
receipt: /Users/poojanpatel/Documents/Projects/tombstone/bench/_work/demo3/.tombstone/receipts/01M25S90NPT0RM9ZCVFCJS9HV4.json   ed25519 signed   chain ok
  VERIFIED  19   UNVERIFIED 4   RESIDUAL 0   OUT_OF_SCOPE 3 (backups, WAL, provider-side embeddings)   NEEDS_HUMAN 2
  id 01M25S90NPT0RM9ZCVFCJS9HV4   semantics v1
  A receipt is a record of what was done and checked. It is not a legal instrument.
exit 2
exit 2
```
